namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        {
            return($"Hello, {Name}! Your robe is {ColorfulRobe.Length} inches long and it contains {string.Join(", ", ColorfulRobe.Colors)} colors. Your hat is {Hat.ShininessDescription}");
